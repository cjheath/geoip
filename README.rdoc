...
You need one of the free GeoLite2 country, city or ASN binary databases, or a subscription database version.
Maxmind have stopped supplying databases in the original GeoLite format - only v2 is currently available.
The download location for the GeoLite databases is <https://dev.maxmind.com/geoip/geoip2/geolite2/>.

This API requires the gzipped binary file to be decompressed for searching.
